...
Partition seed 42 is used for the federated partitioning underlying B2. B2 is repeated using three training seeds (42, 123, 2026) that vary only the stochastic training realization; the partition seed remains fixed across all three runs. Implementation code, dataset-splitting manifests, and configuration files are available at \url{https://github.com/rachmadiantyy/fedx-palm}.
